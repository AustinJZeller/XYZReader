...
public class WideLinearLayout extends LinearLayout {
    ...
    public WideLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs, defStyle, 0);
    }

    public WideLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
